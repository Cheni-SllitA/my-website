...
export default function App() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "An online web application with an admin dashboard with product management and analytics built using the MERN stack.",
      link: "https://rajapaksepharmacy.store/",
    ...
    },
    {
      ...
      description:
        "An online portfolio for the client's business.",
      link: "https://www.probityaccountants.com/",
      image: "../assets/probity.png",
    },
  ];
